...
export class LocalBodyService {
  ...
  constructor(private http: Http) { }
    ...
    downloadLocalBody(stateId: number, distId: number, localBodyType: number) {
      return this.http
          .get(this.baseUrl + '/GetLocalBody?StateId=' + stateId + '&DistId=' + distId + '&LocalBodyTypeId=' + localBodyType + '&MobileNo=7741909862&TokenId=D29D522E-F95B-4191-BF73-440C196177B1')
