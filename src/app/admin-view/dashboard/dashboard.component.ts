...
export class DashboardComponent implements OnInit {
  ...
  public showData(Data: Array<Marks>) {
    ...
    if (Data[0].tmid != null) {
      ...
      for (let i = 0; i < Data.length; i++) {
        ...
        // this.barChartData[i] = { data: [this.mark.subject1, this.mark.subject2, this.mark.subject3, this.mark.subject4], label: this.mark.sid };
        this.barChartData[i] = { data: [this.mark.total_marks], label: this.mark.sid };
        console.log('internal Label:' , this.mark.tmid);
    ...
    //   this.barChartData = [
    //     {data: [this.mark.subject1, this.mark.subject2, this.mark.subject3, this.mark.subject4], label: 'Series A'},
    //     // {data: [28, 48, 40, 19, 86, 27, 90], label: 'Series B'}
    //     // {data: [this.mark.subject1, this.mark.subject2, this.mark.subject3, this.mark.subject4], label: 'Series 8'},
    //   ];

    // this.mark = Data[0];
    // this.doughnutChartLabels = ['subject 1', 'subject 2', 'subject 3', 'subject 4'];
    // this.doughnutChartData = [this.mark.subject1, this.mark.subject2, this.mark.subject3, this.mark.subject4];
  ...
  public chartClicked(e: any) {
    ...
    // first uncomment the line of code within the setTimeout() and notice that 
    // when drilling down on 2006 and then january that the labels don't change anymore.
    // an exception appears on the console.

    // next uncomment the rest of the setTimeout() and notice that everything works 
    // as it should when drilling down on 2006 and then january: data and labels are
    // all updated properly
